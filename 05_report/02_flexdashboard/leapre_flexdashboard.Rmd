...
### The most visible 15 African organisations in RE-related publications between 2011-2020
...
As the Figure \@ref(fig:auregions) presents; to determine the African regions, this study uses [the categorisation provided by African Union](https://au.int/en/member_states/countryprofiles2).
...
* All of the most visible 3 organisations in the selected West African countries Nigeria, Ghana, Senegal are from Nigeria. The number of RE-related publications from *Covenant University*, the most visible organisation in the region, seems to be declining presumably because of the latency in document entries into WoS databases after 2019. 
...
* In the selectedral African countries Cameroon, Dem. Rep. Congo and Gabon, all of the most visible 5 organisations in the region are from Cameroon with the most visible organisation being *Université de Yaoundé I* with 170 RE-related publications in 2020. None of the organisations in the region had published more than 5 RE-related publications in 2011.  
...
None of the last three categories *Multidisciplinary Sciences*, *Material Science* and *Electrical & Electronic Engineering* had more than 1 yearly RE-related publication in *Covenant University* until 2016. However, although there weren't any publications in *Multidisciplinary Sciences* until 2017, it has become one of the most visible categories in *Covenant University's* RE-related publications with yearly over 10 publications. 
